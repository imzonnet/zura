...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	<header class="entry-header">
		<?php if ( is_sticky() && is_home() && ! is_paged() ) : ?>
			<span class="sticky-post"><?php _e( 'Featured', 'zura' ); ?></span>
		<?php endif; ?>
	...
	<div class="entry-content">
		<?php
			...
			the_content( sprintf(
				__( 'Continue reading<span class="screen-reader-text"> "%s"</span>', 'zura' ),
				get_the_title()
			) );
	...
	<footer class="entry-footer">
		...
		<?php
			edit_post_link(
				sprintf(
					/* translators: %s: Name of current post */
					__( 'Edit<span class="screen-reader-text"> "%s"</span>', 'zura' ),
					get_the_title()
				),
