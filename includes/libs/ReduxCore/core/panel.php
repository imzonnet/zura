        ...
        class reduxCorePanel {
            ...
            private function panel_template() {
                ...
                if ( $this->parent->args['dev_mode'] == true ) {
                    ...
                    echo '<br /><div class="redux-timer">' . get_num_queries() . ' queries in ' . timer_stop( 0 ) . ' seconds<br/><a href="http://zuravn.com" title="Where Successful Begins">ZuraVn.Com</a></div>';
                }
